class TaskControls {
  ...
  get fireA() {
    return this.u.justPressedKey('1') || this.u.justPressedButton("A");
  }

  get fireB() {
    return this.u.justPressedKey('2') || this.u.justPressedButton("B");
  }

  get fireC() {
    return this.u.justPressedKey('3') || this.u.justPressedButton("X");
  }
